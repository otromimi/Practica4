...
Prerrequisitos:
Objetivo: Mostrar un mensaje de error en caso de que se escoga una opción no valida.
***********************************************************************************/
void MensajeError(){
...
Objetivo: Comprueva que los dias sean coherentes con el mes ademas de siel año es bisiesto o no.
***************************************/
int date_check(const char date[]){
...
Prerrequisitos: Vector productos.
Objetivo: Muestra por pantalla un listado de todos los productos del almacén (código, nombre y stock actual) que hayan registrado ventas por un importe mayor
al introducido por el usuario y cuyo stock actual sea el mínimo posible para él.
***************************************/
void ListadoProductosConStockMinimo(item productos[]){
...
Objetivo: Muestra el importe de un producto antes introducido por el usuario cada mes del año.
***************************************/
void ListadoVentasProducto(item productos[],float matriz_ventas[][MAXPRODUCTOS]){
...
/***************************************
Subprograma: Ventas totales del año.     Tipo: Procedimiento
Prerrequisitos: Matriz ventas.
